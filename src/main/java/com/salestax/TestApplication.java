...
/*
Test application to verify the refactored sales tax calculator works correctly
with the original test cases from the problem statement.
*/
...
public class TestApplication 
{
    public static void main(String[] args) 
    {
        ...
        // Test data from the original problem statement
        ...
        System.out.println("Testing Refactored Sales Tax Calculator");
        System.out.println("======================================");
        System.out.println();
